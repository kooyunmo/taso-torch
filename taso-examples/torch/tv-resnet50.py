...
if __name__ == '__main__':
    model = resnet50()
    f = open("./log-tv-resnet.txt", 'w')
    f.write("#######################################################################\n");
    f.write("#                    ResNet-50 Performance Evaluation                 #\n");
    f.write("# =================================================================== #\n");
    f.write("#    time: {}                                 #\n".format(datetime.now()));
    f.write("#######################################################################\n\n");
    ...
    torch.onnx.export(model, example_input, "./onnx_models/resnet50.onnx", verbose=True)
    print("##### INFERENCE with onnxruntime (before TASO: traced PyTorch) #####")
    torch_sess = rt.InferenceSession("./onnx_models/resnet50.onnx")
    ...
    old_graph = taso.load_onnx("./onnx_models/resnet50.onnx")
    ...
    onnx.save(new_model, "./onnx_models/resnet50_taso.onnx")
    print("onnx.load()")
